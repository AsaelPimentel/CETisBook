<%@ Page Title="Reportes" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="AdministracionReportes.aspx.vb" Inherits="CETisBook.AdministracionReportes" %>
            ...
            <div class="container">
                <div class="container text-center">
                    <div class="row">
                        ...
                        <div class="col-11">
                            <h1>Administracion de Reportes.</h1>
                        </div>
                    </div>
                </div>
            </div>
